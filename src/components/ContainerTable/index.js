...
class ContainerTable extends Component {
    ...
    generateHeaders = () => {
        ...
        if (this.props.items && this.props.items[0]) {
            ...
            headers.shift(); // Remove the first header if needed
        }
        return headers;
    }
    ...
    renderTable = () => {
        ...
        return (
            <Table multiSelectable={true} onRowSelection={this.onSelected} wrapperStyle={{height: "100%"}}
...
export default connect(
    ...
    dispatch => ({
        setSelected: (rows, type) => dispatch(setSelected(rows, type))
    })
)(ContainerTable);
